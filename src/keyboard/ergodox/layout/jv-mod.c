...
const uint8_t PROGMEM _kb_layout[KB_LAYERS][KB_ROWS][KB_COLUMNS] = {
  ...
  KB_MATRIX_LAYER(0, _esc, _8, _7, _0, _8, _0, _esc, _altL, KEY_LeftBracket_LeftBrace, KEY_SingleQuote_DoubleQuote, KEY_Semicolon_Colon, _P, _Y, _comma, _ctrlL, _A, _O, _E, _U, _I, _shiftL, 50, _Q, _J, _K, _X, _comma, _guiL, 50, _backslash, 2, 1, _ctrlL, _altL, 0, 0, _ctrlL, _bs, _tab, _shiftL, 2, 50, _9, 45, _9, _1, _3, _bracketL, _F, _G, _C, _R, _L, _altL, _D, _H, _T, _N, _S, _ctrlL, _period, _B, _M, _W, _V, _Z, _shiftL, 1, 2, _arrowU, KEY_RightArrow, _guiR, _altL, _ctrlL, _ctrlL, 0, 0, _shiftL, _enter, _space),
...
const void_funptr_t PROGMEM _kb_layout_release[KB_LAYERS][KB_ROWS][KB_COLUMNS] = {
  ...
  KB_MATRIX_LAYER(
                  NULL, kprrel, saltgrprre, saltgrprre, saltgrprre, sshprre, sshprre, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, sshprre, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, lpop2, lpop1, kprrel, kprrel, NULL, NULL, kprrel, kprrel, kprrel, kprrel, kprrel, sshprre, sshprre, kprrel, saltgrprre, sshprre, sshprre, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, lpop1, lpop2, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel, NULL, NULL, kprrel, kprrel, 
                  kprrel
                  ),
